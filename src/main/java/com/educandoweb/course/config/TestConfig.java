...
public class TestConfig implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Product p1 = new Product(null, "The Lord of the Rings", "Lorem ipsum dolor sir amet, consectetur.", 90.5,"");
        Product p2 = new Product(null, "Smart TV", "Nulla eu imperdiet purus, Maecenas ante.", 2190.0,"");
        Product p3 = new Product(null, "Macbook Pro", "Nam eleifend maximus tortor, at mollis", 1250.0,"");
        Product p4 = new Product(null, "Pc Gamer", "Donec aliquet odio ac rhoncus cursus", 1200.0,"");
        Product p5 = new Product(null, "Rail for Dummies", "Cras fringillia convallis vel faucibus", 100.99,"");
        ...
        OrderItem oi3 = new OrderItem(o1, p3, 2, p1.getPrice());
